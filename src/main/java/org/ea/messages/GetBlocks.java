...
public class GetBlocks extends Reply {
    private int version = 70015;
    private long hashCount;
    private List<String> hashes = new ArrayList<>();

    public GetBlocks(int network) {
        super.setCommand("getblocks");
        super.setNetwork(network);
    }

    protected GetBlocks(byte[] msg) throws Exception{
        super(msg);
